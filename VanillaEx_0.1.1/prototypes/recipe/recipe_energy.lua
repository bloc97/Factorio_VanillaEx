...
energy=10,
ingredients={{"solar-panel", 1},{"copper-plate", 15},{"advanced-circuit", 5}},
},
{result="stacked-density-solar",
energy=2,
ingredients={{"solar-panel", 1},{"high-density-solar", 1},{"steel-plate", 4},{"processing-unit", 1}},
},
{result="accumulator2",
energy=5,
...
energy=8,
ingredients={{"steel-plate", 16},{"electric-engine-unit", 1},{"advanced-circuit", 8}},
},
{result="tidal-generator",
energy=8,
ingredients={{"steel-plate", 10},{"electric-engine-unit", 2},{"advanced-circuit", 8}},
},
