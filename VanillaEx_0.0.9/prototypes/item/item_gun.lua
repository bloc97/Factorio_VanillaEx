...
item_gun[1]=util.table.deepcopy(data.raw["gun"]["flame-thrower"])
item_gun[1].name="tank-cannon-flame"
item_gun[1].flags={"goes-to-main-inventory", "hidden"}
item_gun[1].attack_parameters.ammo_category="tank-flame-thrower"
item_gun[1].attack_parameters.cooldown=1
item_gun[1].attack_parameters.range=25
...
item_gun[8].attack_parameters.movement_slow_down_factor=0.8
...
item_gun[10].attack_parameters.range=10
