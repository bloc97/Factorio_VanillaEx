...
item_ammo[6].ammo_type.action.action_delivery.starting_speed=0.4
...
item_ammo[7].ammo_type.action.action_delivery.max_range=50
...
item_ammo[8].ammo_type.action.action_delivery.max_range=60
...
item_ammo[9].ammo_type.action.action_delivery.max_range=50
...
local atomic_shell = util.table.deepcopy(data.raw["ammo"]["artillery-shell"])
atomic_shell.name="atomic-artillery-shell"
atomic_shell.ammo_type.action.action_delivery.projectile = "atomic-artillery-projectile"
atomic_shell.order = "d[explosive-cannon-shell]-da[artillery]",

table.insert(item_ammo, atomic_shell)

local thermonuclear_shell = util.table.deepcopy(data.raw["ammo"]["artillery-shell"])
thermonuclear_shell.name="thermonuclear-artillery-shell"
thermonuclear_shell.ammo_type.action.action_delivery.projectile = "thermonuclear-artillery-projectile"
thermonuclear_shell.order = "d[explosive-cannon-shell]-da[artillery]-c",

table.insert(item_ammo, thermonuclear_shell)
